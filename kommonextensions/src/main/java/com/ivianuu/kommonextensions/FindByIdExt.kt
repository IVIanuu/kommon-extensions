...
inline fun <reified T : View> android.support.v4.app.Fragment.find(@IdRes id: Int): T = view?.findViewById<T>(id) as T
...
inline fun <reified T : View> android.support.v4.app.Fragment.findNullable(@IdRes id: Int): T? = view?.findViewById(id)
